...
Стадия: **V0.1.3 consolidation prototype**
...
- Project-scoped recall boundary tests и JSONL round-trip guardrails.
- Schema placeholder `extraction_confidence` для будущей оценки extractor confidence.
